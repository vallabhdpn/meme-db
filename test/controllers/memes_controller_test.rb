...
class MemesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meme" do
    assert_difference("Meme.count") do
      post memes_url, params: { meme: { SlNo: @meme.SlNo, Title: @meme.Title, description: @meme.description, folder: @meme.folder, tags: @meme.tags } }
    end
  ...
  test "should update meme" do
    patch meme_url(@meme), params: { meme: { SlNo: @meme.SlNo, Title: @meme.Title, description: @meme.description, folder: @meme.folder, tags: @meme.tags } }
